...
// react-resizable-panels v4 renames:
//   PanelGroup       -> Group
//   Panel            -> Panel
//   PanelResizeHandle -> Separator
// We keep the shadcn-style public names so downstream code can `shadcn add resizable`
// later without having to rewrite callers.
