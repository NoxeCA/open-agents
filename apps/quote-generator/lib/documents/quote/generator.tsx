...
import { isQuoteDocumentPlanSectionEnabled } from '@/lib/quote/document/document-plan';
...
export const QuoteDocument: FC<{ data: QuoteData; pageNumbers: PageNumberCollector }> = ({ data, pageNumbers }) => {
  ...
  const isSectionEnabled = (sectionKey: Parameters<typeof isQuoteDocumentPlanSectionEnabled>[1]) =>
    isQuoteDocumentPlanSectionEnabled(data as unknown as Record<string, unknown>, sectionKey);
  ...
  return (
    <Document>
      ...
      {isSectionEnabled("leadership") && data.ceo && (
        <CeoMessagePage
          data={data}
          lang={lang}
          pageHeader={pageHeader}
      ...
      {isSectionEnabled("team") && data.team && (
        <TeamPage
          data={data}
          lang={lang}
          pageHeader={pageHeader}
      ...
      {isSectionEnabled("services") && data.services && data.services.length > 0 && (
        <ServiceSections
          data={data}
          lang={lang}
          selectedLang={selectedLang}
