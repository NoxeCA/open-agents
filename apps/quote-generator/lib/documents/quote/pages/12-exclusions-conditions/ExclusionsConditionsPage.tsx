...
const ExclusionsConditionsPage: FC<ExclusionsConditionsPageProps> = ({
  ...
  >
    ...
    <QuoteEditableRegion
      ...
      anchor="beforeExclusions"
      anchorAliases={["before-exclusions"]}
      regionIds={["commercial:before-exclusions"]}
    ...
    <QuoteEditableRegion
      ...
      section="exclusions-conditions"
      sectionAliases={["commercial", "exclusions"]}
      anchor="beforeSpecialConditions"
      anchorAliases={["before-special-conditions"]}
      regionIds={["commercial:before-special-conditions"]}
      style={styles.sectionGap}
    />
    <Text style={styles.sectionHeading}>
    ...
    <QuoteEditableRegion
      ...
      sectionAliases={["commercial", "exclusions"]}
      anchor="beforeNotes"
      anchorAliases={["before-notes"]}
      regionIds={["commercial:before-notes"]}
      style={styles.sectionGap}
    />
    <Text style={styles.sectionHeading}>
      {data.notes.length > 1
    ...
    <QuoteEditableRegion
      ...
      section="exclusions-conditions"
      sectionAliases={["commercial", "exclusions"]}
      anchor="beforePaymentTerms"
      anchorAliases={["before-payment-terms"]}
      regionIds={["commercial:before-payment-terms"]}
      style={styles.sectionGap}
    />
    <Text style={styles.sectionHeading}>
    ...
    <QuoteEditableRegion
      ...
      sectionAliases={["commercial", "exclusions"]}
      anchor="beforeInfo"
      anchorAliases={["before-info"]}
      regionIds={["commercial:before-info"]}
      style={styles.sectionGap}
    />
    ...
    <QuoteEditableRegion
      ...
      sectionAliases={["commercial", "exclusions"]}
      anchor="afterContact"
      anchorAliases={["after-contact", "footer"]}
      regionIds={["commercial:after-contact"]}
      style={styles.sectionGap}
    />
