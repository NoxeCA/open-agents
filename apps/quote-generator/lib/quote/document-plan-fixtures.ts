...
type QuoteDataOverrides = Partial<QuoteData>;
...
export function buildQuoteFixture(overrides: QuoteDataOverrides = {}): QuoteData {
  return {
    ...baseQuoteData,
    ...overrides,
  };
...
export function buildNormalizedQuoteFixture(
  overrides: QuoteDataOverrides = {},
) {
  return normalizeQuoteData(buildQuoteFixture(overrides));
}
